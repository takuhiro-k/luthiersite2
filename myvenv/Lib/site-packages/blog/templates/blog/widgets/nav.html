<nav class="navbar navbar-expand-lg navbar-dark bg-{{ mysite.color }}">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" target="_blank" href="https://store.shopping.yahoo.co.jp/luthier-of-japan/ " rel="nofollow">SHOP</a>
      </li>
